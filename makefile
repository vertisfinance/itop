...
start_update:
	...
	docker-compose exec itop cp /var/www/html/conf/production/config-itop.php /var/www/html/conf/production/old-config-itop.php
...
end_update:
	...
	docker-compose exec itop rm /var/www/html/conf/production/old-config-itop.php
