<?php
//
// File generated by ... on the 2016-11-15T10:04:12+0100
// Please do not edit manually
//

/**
 * Classes and menus for itop-incident-mgmt-itil (version 2.1.0)
 *
...
class Incident extends Ticket
{
	public static function Init()
	{
		...
		MetaModel::Init_AddAttribute(new AttributeEnum("impact", array("allowed_values"=>new ValueSetEnum("1,2,3"), "display_style"=>'list', "sql"=>'impact', "default_value"=>'3', "is_null_allowed"=>false, "depends_on"=>array(), "always_load_in_tables"=>false)));
		...
		MetaModel::Init_AddAttribute(new AttributeExternalKey("servicesubcategory_id", array("targetclass"=>'ServiceSubcategory', "allowed_values"=>new ValueSetObjects("SELECT ServiceSubcategory WHERE service_id = 1 AND request_type = 'incident' AND status != 'obsolete'"), "sql"=>'servicesubcategory_id', "is_null_allowed"=>true, "on_target_delete"=>DEL_MANUAL, "depends_on"=>array('service_id'), "allow_target_creation"=>false, "display_style"=>'select', "always_load_in_tables"=>false)));
		...
		MetaModel::Init_DefineState(
			...
			array(
				...
				"attribute_list" => array(
					...
					'servicesubcategory_id' =>  OPT_ATT_MANDATORY,
					'service_id' => OPT_ATT_HIDDEN,
		...
		MetaModel::Init_DefineTransition("assigned", "ev_close", array("target_state"=>"closed", "actions"=>array(array('verb' => 'SetCurrentDate', 'params' => array(array('type' => 'attcode', 'value' => "close_date")))), "user_restriction"=>null));
		MetaModel::Init_DefineState(
			"escalated_ttr",
			array(
