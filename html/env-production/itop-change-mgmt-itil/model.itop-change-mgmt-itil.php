						<?php
//
// File generated by ... on the 2017-01-17T08:21:36+0100
// Please do not edit manually
//

/**
 * Classes and menus for itop-change-mgmt-itil (version 2.3.0)
 *
...
class RoutineChange extends Change
{
	public static function Init()
	{
		...
		MetaModel::Init_DefineTransition("implemented", "ev_finish", array("target_state"=>"closed", "actions"=>array(array('verb' => 'SetCurrentDate', 'params' => array(array('type' => 'attcode', 'value' => "close_date")))), "user_restriction"=>null));
		MetaModel::Init_DefineState(
			"monitored",
			array(
		...
		MetaModel::Init_DefineTransition("monitored", "ev_finish", array("target_state"=>"closed", "actions"=>array(array('verb' => 'SetCurrentDate', 'params' => array(array('type' => 'attcode', 'value' => "close_date")))), "user_restriction"=>null));
		MetaModel::Init_DefineState(
			"closed",
			array(
				"attribute_inherit" => 'implemented',
...
class NormalChange extends ApprovedChange
{
	public static function Init()
	{
		...
		MetaModel::Init_DefineTransition("new", "ev_validate", array("target_state"=>"validated", "actions"=>array(array('verb' => 'Reset', 'params' => array(array('type' => 'attcode', 'value' => "reason")))), "user_restriction"=>null));
		...
		MetaModel::Init_DefineTransition("plannedscheduled", "ev_approve", array("target_state"=>"approved", "actions"=>array(array('verb' => 'Reset', 'params' => array(array('type' => 'attcode', 'value' => "reason")))), "user_restriction"=>null));
...
class MenuCreation_itop_change_mgmt_itil extends ModuleHandlerAPI
{
	public static function OnMenuCreation()
	{
		...
		$__comp_menus__['MyChanges'] = new OQLMenuNode('MyChanges', "SELECT Change WHERE agent_id = :current_contact_id AND status NOT IN (\"closed\", \"resolved\")", $__comp_menus__['Change:Shortcuts']->GetIndex(), 1, false, null);
		...
		$__comp_menus__['WaitingApproval'] = new OQLMenuNode('WaitingApproval', "SELECT ApprovedChange WHERE status IN (\"plannedscheduled\")", $__comp_menus__['Change:Shortcuts']->GetIndex(), 3, false, null);
		$__comp_menus__['WaitingApproval']->SetParameters(array('auto_reload' => "fast"));
		$__comp_menus__['WaitingAcceptance'] = new OQLMenuNode('WaitingAcceptance', "SELECT NormalChange WHERE status IN (\"new\")", $__comp_menus__['Change:Shortcuts']->GetIndex(), 4, false, null);
