<?php
//
// File generated by ... on the 2016-11-11T15:54:22+0100
// Please do not edit manually
//

/**
 * Classes and menus for itop-change-mgmt-itil (version 2.1.0)
 *
		...
		MetaModel::Init_DefineState(
			...
			array(
				...
				"attribute_list" => array(
					...
					'' => OPT_ATT_MANDATORY | OPT_ATT_MUSTPROMPT,
				),
			)
		);
		MetaModel::Init_DefineState(
...
class NormalChange extends ApprovedChange
{
	public static function Init()
	{
		...
		MetaModel::Init_DefineTransition("validated", "ev_reject", array("target_state"=>"rejected", "actions"=>array(), "user_restriction"=>null));
		MetaModel::Init_DefineState(
			"rejected",
			array(
				"attribute_inherit" => 'new',
		...
		MetaModel::Init_DefineTransition("validated", "ev_plan", array("target_state"=>"plannedscheduled", "actions"=>array(), "user_restriction"=>null));
		MetaModel::Init_DefineState(
			"plannedscheduled",
			array(
				"attribute_inherit" => 'assigned',
