...
/**
 * Classes and menus for itop-knownerror-mgmt (version 2.3.0)
 *
...
class MenuCreation_itop_knownerror_mgmt extends ModuleHandlerAPI
{
	public static function OnMenuCreation()
	{
		...
		$__comp_menus__['Problem:KnownErrors'] = new OQLMenuNode('Problem:KnownErrors', "SELECT KnownError", $__comp_menus__['Problem:Shortcuts']->GetIndex(), 3, true, null);
		$__comp_menus__['FAQCategory'] = new OQLMenuNode('FAQCategory', "SELECT FAQCategory", $__comp_menus__['Problem:Shortcuts']->GetIndex(), 4.5, true, null);
		$__comp_menus__['FAQ'] = new OQLMenuNode('FAQ', "SELECT FAQ", $__comp_menus__['Problem:Shortcuts']->GetIndex(), 6, true, null);
	}
